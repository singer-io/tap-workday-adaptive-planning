...
from tap_workday_adaptive_planning.sync import write_schema, sync, update_currently_syncing
...
class TestSync(unittest.TestCase):
    ...
    @patch("tap_workday_adaptive_planning.streams.abstracts.IncrementalStream.sync")
