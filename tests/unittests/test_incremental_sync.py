...
class TestSync(unittest.TestCase):
    ...
    @patch("tap_workday_adaptive_planning.streams.abstracts.get_bookmark", return_value=100)
    ...
    @patch("tap_workday_adaptive_planning.streams.abstracts.get_bookmark", return_value=300)
