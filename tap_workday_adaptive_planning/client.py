...
from tap_workday_adaptive_planning.exceptions import ERROR_CODE_EXCEPTION_MAPPING, WorkdayAdaptivePlanningError, WorkdayAdaptivePlanningBackoffError
...
def raise_for_error(response: requests.Response) -> None:
    ...
    if response.status_code not in [200, 201, 204]:
        ...
        exc = ERROR_CODE_EXCEPTION_MAPPING.get(response.status_code, {}).get(
            "raise_exception", WorkdayAdaptivePlanningError
        )
...
class Client:
    ...
    def __init__(self, config: Mapping[str, Any]) -> None:
        ...
        self.base_url = "https://api.adaptiveinsights.com/"
    ...
    @backoff.on_exception(
        ...
        exception=(
            ...
            Timeout,
            WorkdayAdaptivePlanningBackoffError
        ),
        max_tries=5,
        factor=2,
    )
